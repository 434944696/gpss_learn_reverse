...
var _0x174afc = {
        'rVabm': function(_0x1dfca0, _0x22f1dc) {
            return _0x1dfca0(_0x22f1dc);
        }
    };
get_token = function (_0x3b6902){
    var _0x3916ee = {
            'keyword': _0x3b6902
        };
    _0x3916ee = JSON['stringify'](_0x3916ee);
    let _0x515cb6 = _0x174afc['rVabm'](generateHostKey, _0x3916ee);
    let _0x503f02 = getRandomNum(_0x515cb6);
    let _0x1aee69 = getTimeStamp();
    let _0x1e8cc7 = generateHostMD5Key(_0x515cb6, _0x1aee69);
    header = {
                'key': _0x515cb6,
                'rd': _0x503f02,
                'ts': "" + _0x1aee69,
...
console.log(get_token('oscs1024.com'))